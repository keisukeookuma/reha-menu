                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row justify-content-center">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <label for="agreement" class="text-md-right">利用規約に同意する</label>
                                        @error('agreement')
                                    ...
                                    <div class="agreement col-md-10 rounded">
                                        <div>
                                            <p class="h5 pt-2">利用規約</p>
                                            <p>この利用規約（以下，「本規約」といいます。）は，RehaMenu事務局（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                                        </div>
                                        <div>
                                            <p class="h6">第1条（適用）</p>
                                            <ol type="1">
                                        ...
                                        <div>
                                            <p class="h6">第3条（ユーザーIDおよびパスワードの管理）</p>
                                            <ol type="1">
                                        ...
                                        <div>
                                            <p class="h6">第10条（保証の否認および免責事項）</p>
                                            <ol type="1">
                                        ...
                                        <div>
                                            <p class="h6">第15条（権利義務の譲渡の禁止）</p>
                                            <p>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                                        </div>
                                        <div>
                                            <p class="h6">第16条（準拠法・裁判管轄）</p>
                                            <ol type="1">
