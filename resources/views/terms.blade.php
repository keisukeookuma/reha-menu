...
<main>
    <div class="container mt-5 pt-5">
        <div>
            <p class="h5 py-2">【ご利用にあたってのルール】</p>
            <p>当サイトで使用しているイラストや写真、作成したリハビリメニューは下記禁止事項に当てはまらない限り、個人、法人、商用、非商用問わず無料でご利用頂けます。</p>
                <p>禁止事項 当サイトのイラストや写真、作成したリハビリメニューは以下の場合、ご利用をお断りします。</p>
                <ul>
                    <li>法令または公序良俗に違反する行為</li>
                    <li>イラストや写真のイメージを損なうような攻撃的・差別的・性的・過激な利用</li>
                    <li>反社会的勢力や違法行為に関わる利用</li>
                    <li>イラストや写真自体をコンテンツ・商品として再配布・販売</li>
                    <li>その他著作者が不適切と判断した場合</li>
                </ul>
            <p>著作権</p>
            <p>当サイトのイラストや写真、作成したリハビリメニューは無料でお使い頂けますが、著作権は放棄しておりません。全てのイラストや写真の著作権はRehaMenu事務局もしくは投稿したユーザーが所有します。</p>
        </div>
        <div>
            <p class="h5 pt-2">【会員ユーザー向け利用規約】</p>
    ...
    <a type="button" class="btn btn-secondary col-6 offset-3 w-100 mt-2 mb-4 text-light" href="{{ $return_url }}">元のページに戻る</a>
</main>
@endsection
